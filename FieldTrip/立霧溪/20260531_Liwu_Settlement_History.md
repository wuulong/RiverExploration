...
description: "本篇將立霧溪流域大縱走探索路線中的核心空間點位（得其黎、新城、塔比多、合流、關原、人止關），與《臺灣通史》原典記載及 HGIS 空間脈絡進行時空對照整合。深入剖析地名由來、歷史防禦功能與聚落變遷。"
---

# 立霧溪流域聚落時空交集與空間脈絡

在立霧溪流域「東進西退」大縱走的 5 天 4 夜探索計畫中，每一個紮營車宿點與地貌節點，都是歷史洪流中極具分量的空間地標。本篇將實地探索的核心 POIs（Point of Interest），與 HGIS 歷史文獻資料庫之記載進行時空對照整合與空間厚化，重現這些聚落與隘口的時空演變。
